...
describe('Voluntario Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'voluntario', component: VoluntarioComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.voluntarios?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to voluntarioService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getVoluntarioIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getVoluntarioIdentifier).toHaveBeenCalledWith(entity);
